...
def run_model(df_2class):
    # Save the input data
    df_2class.to_csv('bioactivity_data_5.csv', index=False)
...
def api_process_target():
    ...
    try:
        ...
        result = {
            ...
            'dataset': dataset.head(20).to_dict(orient='records'),  # Limit to 20 rows for efficiency
...
def download_data():
    try:
        return send_file('bioactivity_data_3.csv', 
                         mimetype='text/csv',
                         as_attachment=True,
